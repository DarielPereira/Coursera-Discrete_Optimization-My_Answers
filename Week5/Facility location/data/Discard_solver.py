...
def solve_it(input_data):
    ...
    if facility_count + customer_count == 75 or facility_count + customer_count == 200 or facility_count + customer_count == 250:
        ...
        if facility_count + customer_count == 3500 or facility_count + customer_count == 2500:
            grids = 11
            number_updates = 100
            number_facility_updates = 5
        ...
        for update in range(number_updates):
            random.seed(update)
            facility_update_indexes = random.sample((df_facilities.loc[df_facilities['in_Use'] == 1].index).to_list(),
                                                    number_facility_updates)
            facility_update_indexes += random.sample((df_facilities.loc[df_facilities['in_Use'] == 0].index).to_list(),
                                                     number_facility_updates)
    ...
    # if facility_count+customer_count==1000 or facility_count+customer_count==3500 or facility_count+customer_count==2500:
