...
input_location = '././data/vrp_26_8_1'
...
if vehicle_count + customer_count == 34:
    ...
    trivial_vehicle_tours = trivial_solution_vehicleCount(customers, vehicle_count, vehicle_capacity, customer_count)
    ...
    vehicle_tours, df_customers = ray_solution(customers, locations, vehicle_capacity, customer_count, route_limit=13)
    ...
    df_customers, vehicle_tours = run_MIPoptimization(df_customers, vehicle_tours, vehicle_capacity, distance_matrix)
...
obj = computeObjective(vehicle_tours, M)
print('objective: {}'.format(obj))
